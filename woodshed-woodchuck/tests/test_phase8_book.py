...
def test_book_has_contest_team_and_verification_controls() -> None:
...
def test_missing_selection_and_gold_pulse_architecture() -> None:
    ...
    for label in ("Choose a Team", "Submit Without Team Competition"):
        assert label in script
    assert "p-book-email-copy" not in script
